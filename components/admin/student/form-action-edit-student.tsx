...
const FormActionEditUser = ({ user }: { user: Student }) => {
    const UpdateUser = updateStudent.bind(null, user.id);
    ...
    return (
        <div className="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold text-center mb-6">Edit Student Information</h2>
            ...
            <form action={formAction} className="flex flex-col gap-4">
                ...
                <div>
                    <label htmlFor="parent" className="block text-sm font-medium text-gray-700">Parent</label>
                    <input 
                        type="text" 
                        name="parent" 
                        defaultValue={user.parent || ''} 
                        className="mt-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full" 
                    />
                </div>
                <div>
